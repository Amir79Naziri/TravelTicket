...
public class CreateTickets
{
    public static void main(String[] args)
    {
        ...
        ticketStorage.getTickets().put(769, new Ticket("Mashhad", "Kish", "Qatar Airlines", 2,
                0, 3, 30, 2021, 2, 6,
                2020, 12, 21, 769, 600));

        ticketStorage.getTickets().put(770, new Ticket("Shiraz", "Kish", "American Airlines", 2,
                0, 3, 30, 2021, 2, 7,
                2020, 12, 21, 770, 1980));

        ticketStorage.getTickets().put(771, new Ticket("Isfahan", "shiraz", "Pegasus Airlines", 2,
                0, 3, 30, 2021, 2, 6,
                2020, 12, 21, 771, 1900));
